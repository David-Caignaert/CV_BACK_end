...
<body>
<h1>modifier un centre d'interet</h1>
  <table class='table'>
    <thead>
      <tr>
        <th scope="col">ID</th>
    ...
    <tbody class='liste_centre_interet'>
      <tr class='ligne_centre_interet'>
        ...
        <td><a href="modCentre.php?{{id_sup_centre}}"><i class="far fa-edit"></i></a></td>
      </tr>
    </tbody>
  </table>
  <hr>
  <h1>modifier une experience pro</h1>
  <table class='table'>
    <thead>
      <tr>
        <th scope="col">ID</th>
    ...
    <tbody class='liste_experience_pro'>
      <tr class='ligne_experience_pro'>
        ...
        <td><a href="modExp.php?{{id_sup_experience}}"><i class="far fa-edit"></i></a></td>
      </tr>
    </tbody>
  </table>
  <hr>
  ...
  <table class='table'>
    ...
    <tbody class='liste_formation'>
      <tr class='ligne_formation'>
        ...
        <td><a href="modForm.php?{{id_sup_formation}}"><i class="far fa-edit"></i></a></td>
      </tr>
    </tbody>
  </table>
  <hr>

  <h1>modifier un language de programmation</h1>
  <table class='table'>
    <thead>
      <tr>
        <th scope="col">ID</th>
    ...
    <tbody class='liste_language'>
      <tr class='ligne_language'>
        ...
        <td><a href="modLang.php?{{id_sup_language}}"><i class="far fa-edit"></i></a></td>
      </tr>
    </tbody>
  </table>
  <hr>
  ...
  <table class='table'>
    ...
    <tbody class='liste_candidat'>
      <tr class='ligne_candidat'>
        ...
        <td><a href="modCandidat.php?{{id_sup_candidat}}"><i class="far fa-edit"></i></a></td>
      </tr>
    </tbody>
  </table>
  <hr>
