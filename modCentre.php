...
<body>
  <form id="form">
    ...
    <div class="alert alert-warning text-center">
      Voulez-vous vraiment modifier ce centre d'interet ?
    </div>
    ...
    document.querySelector("#form")
        .addEventListener("submit", function(event){
          console.log('bou');
            ...
            params2.append('intitule',document.querySelector('#intitule_centre_interet').value)
            // Ajax
            axios.post('update/updateCentreInteret.php', params2)
            .then((response) =>{    
              console.log('response',response);     
